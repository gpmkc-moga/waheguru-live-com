          ...
          <a :href="constants.photoGalleryLink">
            <div class="gallery-link-text">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <title>{{ constants.facebook }}</title>
                <path
                  d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"
                />
              </svg>
              <div>{{ constants.photoGallery }}</div>
            </div>
          </a>
          <nuxt-link to="/gallery/audio">
            <div class="gallery-link-text">
              <svg
                role="img"
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <title>{{ constants.audioGallery }}</title>
                <path
                  d="M18 3a1 1 0 00-1.196-.98l-10 2A1 1 0 006 5v9.114A4.369 4.369 0 005 14c-1.657 0-3 .895-3 2s1.343 2 3 2 3-.895 3-2V7.82l8-1.6v5.894A4.37 4.37 0 0015 12c-1.657 0-3 .895-3 2s1.343 2 3 2 3-.895 3-2V3z"
                />
              </svg>
              <div>{{ constants.audioGallery }}</div>
            </div>
          </nuxt-link>
          <a :href="constants.instagramGalleryLink">
            <div class="gallery-link-text">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <title>{{ constants.instagram }}</title>
                <path
              ...
              <div>{{ constants.instagramGallery }}</div>
            </div>
          </a>
        </div>
      </template>
